...
dataset  <- fread("C:/Users/ICBC/Desktop/Mineria/labo/exp/FE4020/paquete_premium_202011_ext.csv", stringsAsFactors= TRUE) 

#creo la carpeta donde va el experimento
# HT  representa  Hiperparameter Tuning
dir.create( "./labo/exp/",  showWarnings = FALSE ) 
dir.create( "./labo/exp/HT4330FE/", showWarnings = FALSE )
setwd("C:/Users/ICBC/Desktop/Mineria/labo/exp/HT4330FE/")   #Establezco el Working Directory DEL EXPERIMENTO
