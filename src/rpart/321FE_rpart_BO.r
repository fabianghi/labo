...
#cargo el dataset
dataset  <- fread("C:/Users/ICBC/Desktop/Mineria/labo/exp/FE4020/paquete_premium_202011_ext.csv")   #donde entreno
...
dir.create( "./labo/exp/HT3210FE/", showWarnings = FALSE )
setwd("C:/Users/ICBC/Desktop/Mineria/labo/exp/HT3210FE/")   #Establezco el Working Directory DEL EXPERIMENTO


archivo_log  <- "HT321FE.txt"
