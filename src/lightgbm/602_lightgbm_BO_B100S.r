...
kdataset       <- "./datasets/paquete_premium_ext_001_1.csv.gz"

#donde entrenar
ktrain_mes_desde    <- 202001        #mes desde donde entreno
ktrain_mes_hasta    <- 202001        #mes hasta donde entreno, inclusive
ktrain_meses_malos  <- c( 202006 )   #meses a excluir del entrenamiento


kexperimento   <- paste0( kprefijo, "B100S" )
kbayesiana     <- "BO.RDATA"
klog           <- "BO_log.txt"
